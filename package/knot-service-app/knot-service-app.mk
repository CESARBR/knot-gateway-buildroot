...
KNOT_SERVICE_APP_VERSION = KNOT-v02.01
...
KNOT_SERVICE_APP_DEPENDENCIES = libglib2 json-c libell knot-protocol-lib knot-hal-driver rabbitmq-c
...
define KNOT_SERVICE_APP_INSTALL_INIT_SCRIPT
	$(INSTALL) -D -m 0755 $(KNOT_SERVICE_APP_PKGDIR)/S70knotd-daemon $(TARGET_DIR)/etc/knot/initS/S70knotd-daemon
	$(INSTALL) -D -m 0755 $(KNOT_SERVICE_APP_PKGDIR)/S81inetbrd-daemon $(TARGET_DIR)/etc/knot/initS/S81inetbrd-daemon
endef
