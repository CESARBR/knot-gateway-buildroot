...
KNOT_SERVICE_APP_CONF_ENV = CFLAGS="-I$(@D)/../knot-protocol-lib-$(KNOT_SERVICE_APP_VERSION)/src -I$(@D)/../knot-hal-driver-$(KNOT_SERVICE_APP_VERSION)" LIBS="$(@D)/../knot-protocol-lib-$(KNOT_SERVICE_APP_VERSION)/src/libknotprotocol.a $(@D)/../knot-hal-driver-$(KNOT_SERVICE_APP_VERSION)/src/hal/log/libhallog.a"
