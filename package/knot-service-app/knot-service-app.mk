...
KNOT_SERVICE_APP_VERSION = KNOT-v01.02-rc01
...
KNOT_SERVICE_APP_CONF_ENV = CFLAGS="-I$(@D)/../knot-protocol-lib-KNOT-v01.02-rc01/src" LIBS="$(@D)/../knot-protocol-lib-KNOT-v01.02-rc01/src/libknotprotocol.a"
...
define KNOT_SERVICE_APP_INSTALL_INIT_SCRIPT
	$(INSTALL) -D -m 0755 $(KNOT_SERVICE_APP_PKGDIR)/S65knotd-daemon $(TARGET_DIR)/etc/init.d/
endef
