...
KNOT_VIRTUALTHING_VERSION = KNOT-v03.00-rc01
...
KNOT_VIRTUALTHING_DEPENDENCIES = libell json-c rabbitmq-c knot-protocol-lib \
				libmodbus
...
define KNOT_VIRTUALTHING_INSTALL_CONF_FILES
	...
	$(INSTALL) -D -m 0644 $(@D)/confs/rabbitmq.conf $(TARGET_DIR)/etc/knot/
endef
...
define KNOT_VIRTUALTHING_INSTALL_INIT_SCRIPT
	$(INSTALL) -D -m 0755 $(KNOT_VIRTUALTHING_PKGDIR)/S65kthingd-daemon \
