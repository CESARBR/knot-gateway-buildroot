...
MAINFLUX_BUILD_TARGETS = cmd/users cmd/things cmd/authn
...
define MAINFLUX_INSTALL_INIT_SCRIPT
	...
	$(INSTALL) -D -m 0755 $(MAINFLUX_PKGDIR)/S95mainflux-authn $(TARGET_DIR)/etc/init.d/
endef
...
define MAINFLUX_INSTALL_TARGET_CMDS
	...
	cp $(MAINFLUX_PKGDIR)/authn.conf $(TARGET_DIR)/usr/local/mainflux/
	...
	$(INSTALL) -D -m 0755 $(@D)/bin/authn $(TARGET_DIR)/usr/local/mainflux/bin/
endef
